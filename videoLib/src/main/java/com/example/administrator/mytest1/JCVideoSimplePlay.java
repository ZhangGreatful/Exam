...
// * On 2016/04/18 16:15
// */
//public class JCVideoSimplePlay extends JCVideoPlayer {
//
...
//
//
//    public JCVideoSimplePlay(Context context) {
//        super(context);
//    }
//
//    public JCVideoSimplePlay(Context context, AttributeSet attrs) {
//        super(context, attrs);
//    }
//
//    @Override
...
//        loadingProgressBar = (ProgressBar) findViewById(R.id.loading1);
...
//            fullscreenButton.setImageResource(R.drawable.jc_shrink);//修改重力变化的充满屏幕
...
//        return R.layout.jc_layout_jcsimple;
//    }
//
//    @Override
...
////        if (secProgress != 0) bottomProgressBar.setSecondaryProgress(secProgress);//缓存进度条
//
//        //添加时间的回调 每秒返回一次当前时间和进度  progress>=98 设置为结束 调取照相
//
//    }
//
//
