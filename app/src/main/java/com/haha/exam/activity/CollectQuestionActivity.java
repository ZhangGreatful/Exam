...
public class CollectQuestionActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initData() {
        dao = new ExamDao(CollectQuestionActivity.this);
...
//            获取全部收藏
            ...
            OkGo.post(WebInterface.check_save)
                    ...
                    .execute(new StringCallback() {
                        ...
                        public void onSuccess(String s, Call call, Response response) {
                            Toast.makeText(CollectQuestionActivity.this, "从网络获取收藏成功", Toast.LENGTH_SHORT).show();
            ...
            OkGo.post(WebInterface.check_save)
                    ...
                    .execute(new StringCallback() {
                        @Override
                        public void onSuccess(String s, Call call, Response response) {
                            Toast.makeText(CollectQuestionActivity.this, "从网络获取错题成功", Toast.LENGTH_SHORT).show();
                            AllQuestions allQuestions = gson.fromJson(s, AllQuestions.class);
                            datas = allQuestions.getData();
                            if (layoutAdapter != null) {
                                layoutAdapter.setDataList(datas);
                ...
                OkGo.post(WebInterface.delete_collect)
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onSuccess(String s, Call call, Response response) {
                                ...
                                Toast.makeText(CollectQuestionActivity.this, string.getMsg(), Toast.LENGTH_SHORT).show();
                            }
                        });
