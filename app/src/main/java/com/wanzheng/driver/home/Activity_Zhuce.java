...
public class Activity_Zhuce extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__zhuce);
    ...
    private void initView() {
        ...
        userNameEdt = (EditText) findViewById(R.id.zhuce_username);
        ...
        // }
        // });
        passwordEdt = (EditText) findViewById(R.id.zhuce_password);
        submintBtn = (Button) findViewById(R.id.zhuce_pho_psw);
        submintBtn.setOnClickListener(this);
        zhuceBtn = (Button) findViewById(R.id.zhuce);
        zhuceBtn.setOnClickListener(this);
        phopwdEdt = (EditText) findViewById(R.id.zhuce_phonepassword);
        eye_key = (ImageView) findViewById(R.id.eye_key);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.zhuce:
                ...
                if ("".equals(mobile1)) {
                    Toast.makeText(Activity_Zhuce.this, "请输入正确的手机号码",
...
//						getPhomsgCallBack);
    ...
    private StringCallback registerCallBack = new StringCallback() {
        ...
        public void onSuccess(String s, Call call, Response response) {
            ...
            if (msg == 1) {
                su.savePhone(userNameEdt.getText().toString());
    ...
    private StringCallback getPhomsgCallBack = new StringCallback() {
        @Override
        public void onSuccess(String s, Call call, Response response) {
    ...
    private NetWorkCallBack<BaseResult> chekPhoneCallBack = new NetWorkCallBack<BaseResult>() {

        @Override
        public void onComplete(String json) {
            int msg = JsonUtils.parseIsexists(json);
            if (msg == 1) {
                toast("用户已存在");
            } else if (msg == 0) {
...
//	};
    ...
    private void toast(final String str) {
        handler.post(new Runnable() {
            ...
            public void run() {
                // TODO Auto-generated method stub
                Toast.makeText(Activity_Zhuce.this, str, Toast.LENGTH_LONG)
                        .show();
            }
        });
